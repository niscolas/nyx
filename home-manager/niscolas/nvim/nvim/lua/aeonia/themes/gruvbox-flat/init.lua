...
M.fzf_lua_setup_hls = require("aeonia.themes.gruvbox-flat.fzf_lua").setup_hls

M.fzf_lua_fzf_colors = require("aeonia.themes.gruvbox-flat.fzf_lua").fzf_colors

M.navic_setup_hl = require("aeonia.themes.gruvbox-flat.navic").setup_hl

M.cmp_setup_hl = require("aeonia.themes.gruvbox-flat.cmp").setup_hl
